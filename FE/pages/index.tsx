...
const Home: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        {isAtTop && (
          <div className="px-6 ex:px-0 flex items-end text-mist-white justify-between md:hidden md:w-[240px]">
            <Image
        ...
        <div className="flex flex-1 justify-between md:justify-end gap-4 z-[2] pl-6 pr-0 max-w-[94vw] md:max-w-[calc(100vw-400px)] md:pr-6 ex:relative ex:px-0 ex:pr-0">
          <SearchBar forceShrink={Object.values(appliedFilters).filter(value => value !== null && value !== '').length} />
